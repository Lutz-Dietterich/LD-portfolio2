...
export default async function handler(req, res) {
    if (req.method === "POST") {
        ...
        const emailContent = ReactDOMServer.renderToString(<EmailTemplate firstName={firstName} message={message} />);
      ...
      `;
        ...
        try {
            ...
            console.error("Detaillierter Nodemailer/SMTP-Fehler:", error);
